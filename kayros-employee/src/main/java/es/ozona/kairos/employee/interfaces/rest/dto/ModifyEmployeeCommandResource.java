...
public class ModifyEmployeeCommandResource {
	...
	@NotEmpty
	@Length(min = 3)
	@ApiModelProperty(value = "The employee user name.", required = true, position = 2, allowEmptyValue = false, example = "mqueizan")
	private String username;

	@NotEmpty
	@Length(min = 3, max = 50)
	@ApiModelProperty(value = "The employee first name", required = true, position = 3, allowEmptyValue = false, example = "Maria Xose")
	private String firstname;

	@NotEmpty
	@Length(min = 3, max = 50)
	@ApiModelProperty(value = "The employee last name.", required = true, position = 4, allowEmptyValue = false, example = "Queizan")
	...
	public ModifyEmployeeCommandResource(String employeeId, String username, String firstname, String lastname, String email, String preferredLanguage,
	...
	public boolean equals(Object obj) {
		...
		if (obj == null || !(obj instanceof ModifyEmployeeCommandResource)) {
			return false;
		}

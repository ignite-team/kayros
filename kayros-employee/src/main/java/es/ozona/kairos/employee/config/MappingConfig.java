...
public class MappingConfig {
	...
	public MCModelMapper getModelMapper() {
		...
		modelMapper.createTypeMap(Employee.class, EmployeeResource.class).addMapping(s -> s.getAccount().getUsername(), EmployeeResource::setUsername)
		...
		modelMapper.createTypeMap(Schedule.class, ScheduleResource.class).addMapping(s -> s.getValidity().getStartDate(), ScheduleResource::setStartDate)

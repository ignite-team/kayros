package es.ozona.kayros.webapp.layouts;
...
import es.ozona.kayros.webapp.backend.BackendService;
import es.ozona.kayros.webapp.backend.Employee;
import es.ozona.kayros.webapp.views.MainView;
...
public class MasterDetailView extends Div implements AfterNavigationObserver {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1430876369637782197L;

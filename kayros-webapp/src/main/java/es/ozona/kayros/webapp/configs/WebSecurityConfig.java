...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private static final String[] ZK_RESOURCES = { "/zkau/web/**/js/**", "/zkau/web/**/zul/css/**", "/zkau/web/**/font/**", "/zkau/web/**/img/**",
			"/zkau/web/**/css/**", "/img/**" };
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers(ZUL_FILES).denyAll() // block direct access to zul files
				...
				.requestMatchers(req -> "dummy".equals(req.getParameter("cmd_0")) || "onMove".equals(req.getParameter("cmd_0")) || "rmDesktop".equals(req.getParameter("cmd_0"))).permitAll() // allow zk resources

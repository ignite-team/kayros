...
@ApiModel(description = "A workday resource")
public class AddWorkdayResource {
	...
	public AddWorkdayResource() {

	}

	public AddWorkdayResource(DayOfWeek day, LocalTime worktimeEntry, LocalTime worktimeExit, LocalTime breakTimeStart,

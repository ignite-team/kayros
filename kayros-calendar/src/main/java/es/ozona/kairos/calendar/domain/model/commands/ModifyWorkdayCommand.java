...
public class ModifyWorkdayCommand {
	...
	public ModifyWorkdayCommand() {

	}

	public ModifyWorkdayCommand(String shiftplanId, DayOfWeek day, LocalTime worktimeEntry, LocalTime worktimeExit, LocalTime breakTimeStart,

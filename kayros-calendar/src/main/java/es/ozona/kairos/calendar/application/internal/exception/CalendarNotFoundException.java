...
public class CalendarNotFoundException extends ApplicationException {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -9153718468819336675L;
	...
	public CalendarNotFoundException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {

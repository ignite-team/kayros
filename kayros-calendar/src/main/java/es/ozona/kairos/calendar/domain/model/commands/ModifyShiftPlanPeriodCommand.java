...
public class ModifyShiftPlanPeriodCommand {
	private String shiftPlanId;
	private String calendarId;
	private LocalDate startDate;
	private LocalDate endDate;

	public ModifyShiftPlanPeriodCommand() {

	}

	public ModifyShiftPlanPeriodCommand(String shiftPlanId, String calendarId, LocalDate startDate, LocalDate endDate) {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null || !(obj instanceof ModifyShiftPlanPeriodCommand)) {
			return false;
		}
